...
final class StringToItemParser extends StringToTParser{
	 ...
	 * @phpstan-return list<array{alias: string, id: int, meta: int|string}>
	 */
	public function getRegisteredItemsDetails() : array{
		$itemDetails = [];
	...
	public function getItemByAlias(string $alias) : Item{
		if(isset($this->registeredItems[$alias])){
			$item = ($this->registeredItems[$alias])($alias);

			if($item instanceof Item){
				return $item;
			} else {
				throw new \RuntimeException("Invalid item instance for alias: $alias");
			}
		} else {
			throw new \InvalidArgumentException("Alias not registered: $alias");
		}
	}
