...
final class YmlServerProperties{
	...
	public const SETTINGS_DISCORD_WEBHOOK_MESSAGE = 'settings.webhook-message';
	/**public const SETTINGS_DISCORD_WEBHOOK_URL = 'webhook-settings.url';
	public const SETTINGS_DISCORD_WEBHOOK_NAME = 'webhook-settings.bot-name';
	public const SETTINGS_DISCORD_WEBHOOK_AVATAR = 'webhook-settings.avatar';*/
