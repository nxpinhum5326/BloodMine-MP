...
final class KnownTranslationFactory{
	...
	public static function commands_weather_usage() : Translatable{
		return new Translatable(KnownTranslationKeys::COMMANDS_WEATHER_USAGE, []);
	}
	...
	public static function pocketmine_webhook_edition_faker(Translatable|string $playerName) : string{
		$string  = new Translatable(KnownTranslationKeys::POCKETMINE_WEBHOOK_EDITION_FAKER, [
			"player" => $playerName
		]);
	...
	public static function pocketmine_disconnect_suspect() : Translatable{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_SUSCPECT, []);
	}
